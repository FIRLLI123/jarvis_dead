...
public class Penjualan_group_item extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.penjualan_group_item);

        context = Penjualan_group_item.this;
...
//                .addBodyParameter("tanggal", tanggalinputperdana1.getText().toString())
    ...
    private void pilihan_gabung(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "list_penjualan_group_item_gabung.php" )
                .addBodyParameter("item", hasilpilihan1.getText().toString())
                .addBodyParameter("tanggal", tanggalsampai.getText().toString())
