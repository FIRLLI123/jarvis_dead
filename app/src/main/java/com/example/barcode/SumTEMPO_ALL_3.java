...
public class SumTEMPO_ALL_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_tempo_all3);
        ...
        Intent i = getIntent();
        String kiriman3 = i.getStringExtra("tanggaldari");
        tanggaldari.setText(kiriman3);
        String kiriman4 = i.getStringExtra("tanggalsampai");
        tanggalsampai.setText(kiriman4);

        String kiriman5 = i.getStringExtra("hasilpilihan1");
        hasilpilihan1.setText(kiriman5);
        String kiriman6 = i.getStringExtra("hasilpilihan2");
        hasilpilihan2.setText(kiriman6);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listtempooutlet2.php" )
...
//                        total = 0;
    ...
    private void masihtempo() {
        ...
        AndroidNetworking.post(Config.host + "masihtempo2.php")
                .addBodyParameter("idoutlet", idoutlet.getText().toString())
    ...
    private void sudahdibayarkan() {
        ...
        AndroidNetworking.post(Config.host + "sudahdibayar2.php")
                .addBodyParameter("idoutlet", idoutlet.getText().toString())
                //.addBodyParameter("namasales", namasales.getText().toString())
                //.addBodyParameter("bulan", sp.getSelectedItem().toString())
                //.addBodyParameter("bulan", bulan1.getText().toString())
