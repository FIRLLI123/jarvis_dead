...
public class SumaryRupiah extends AppCompatActivity {
    TextView tes1;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sumary_rupiah);
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumbayar.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listrupiah,
                new String[] {"namasales","tanggal"},
                new int[] {R.id.namasaleslisttest, R.id.tanggallisttest});
        ...
        listtest1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String b = namasaleslist1.getText().toString();
                //String c = namasalesinputperdana1.getText().toString();
                Intent i = new Intent(getApplicationContext(), SumaryRupiah2.class);
                i.putExtra("tanggal",""+a+"");
                i.putExtra("namasales",""+b+"");
                startActivity(i);
