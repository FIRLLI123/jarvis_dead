package com.example.barcode.Until;
...
public class PrinterCommands {
    ...
    public static final byte[] biasa = new byte[] { 0x1b, 0x21, 0x10 };
    public static final byte[] besar = new byte[] { 0x1b, 0x21, 0x30 };
    public static final byte[] kecil = new byte[] { 0x1b, 0x21, 0x8 };
    public static final byte[] small = new byte[]{0x1B,0x21,0x00};
