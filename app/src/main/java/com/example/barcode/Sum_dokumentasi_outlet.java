...
public class Sum_dokumentasi_outlet extends AppCompatActivity {
TextView namaoutlet, id_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_dokumentasi_outlet);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "dokumentasi_outlet.php" )
...
//                namasales.setText(namasaleslist);
                ...
                Intent i = new Intent(getApplicationContext(), Sum_dokumentasi_outlet2.class);
                i.putExtra("id",""+a+"");
                startActivity(i);
