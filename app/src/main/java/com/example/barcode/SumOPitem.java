...
public class SumOPitem extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_opitem);
...
//            mService.sendMessage("Harga Sudah Termasuk PPN 10%", "");
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(SumOPitem.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumopitem.php" )
