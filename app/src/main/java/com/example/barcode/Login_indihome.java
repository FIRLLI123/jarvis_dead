...
public class Login_indihome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_indihome);

        context = Login_indihome.this;
...
//                String perusahaan_alert = perusahaan.getText().toString();
    ...
    private void loginn() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppVar3.LOGIN_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(AppVar3.KEY_EMAIL, username);
                params.put(AppVar3.KEY_PASSWORD, password);
    ...
    private void gotoCourseActivity() {
        ...
        Intent intent = new Intent(context, Dashboard_indihome.class);
