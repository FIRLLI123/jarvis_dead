...
public class SumITEM_ALL_PERDANA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_item_all_perdana);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listpenjualanitemperdana.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listtpenjualanitem,
                new String[] {"item","qty"},
                new int[] {R.id.namaitemlistpenjualanall,R.id.qtylisttempooutlet});
