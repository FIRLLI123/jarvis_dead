...
public class SumOP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_op2);
...
//        });
        ...
        sumitem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (namaoutletlist1.getText().toString().length() == 0) {                    //1
                    ...
                    String d = tes1.getText().toString();
                    Intent i = new Intent(getApplicationContext(), SumOPitem.class);
                    //i.putExtra("idoutlet",""+a+"");
    ...
    private void list() {
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post(Config.host + "sumop2.php")
...
//                        total = 0;
    ...
    private void Adapter() {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listsumop2,
