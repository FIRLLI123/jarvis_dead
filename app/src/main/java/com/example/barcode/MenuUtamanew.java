...
public class MenuUtamanew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_utamanew);
        ...
        inputvoucher.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if ( namasf3.getText().toString().equals("Menunggu Koneksi...")){
                    ...
                    String b = namaoutmenu1.getText().toString();
                    String c = namasf3.getText().toString();
                    Intent i = new Intent(getApplicationContext(), InputVoucherEX.class);
                    i.putExtra("idoutlet",""+a+"");
                    i.putExtra("namaoutlet",""+b+"");
                    i.putExtra("namasales",""+c+"");
                    startActivity(i);
        ...
        inputlink.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
        ...
        inputop1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        inputopvc1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
