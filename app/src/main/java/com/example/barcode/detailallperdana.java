...
public class detailallperdana extends AppCompatActivity {
    TextView tes1, tanggal;
    ListView listtest1;
    Button refresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detailallperdana);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "detailperdana.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listdetail,
                new String[] {"namaoutlet","namasales","namaitem","qty","jam"},
                new int[] {R.id.namaoutletlist, R.id.namasaleslist, R.id.namaitemlist, R.id.qtylist, R.id.jamlist});
