...
public class SumVoucher2 extends AppCompatActivity {
    TextView tes1, namaoutletlist1, idoutletlist1, tanggalsampai;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_perdana2);
        ...
        sumitem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (namaoutletlist1.getText().toString().length() == 0) {                    //1
                    ...
                    String d = tes1.getText().toString();
                    Intent i = new Intent(getApplicationContext(), SumVoucherItem.class);
                    //i.putExtra("idoutlet",""+a+"");
