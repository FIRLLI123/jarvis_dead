...
public class SumRiwayatStok2 extends AppCompatActivity {
    TextView tes1, namaoutletlist1, idoutletlist1, total_item;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_riwayat_stok2);
...
//        });
    ...
    private void list() {
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post(Config.host + "riwayatstok2.php")
...
**/
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                map.put("qtysebelum",       responses.optString("qtysebelum"));
                                map.put("qty",       responses.optString("qty"));
                                map.put("qtysekarang",       responses.optString("qtysekarang"));
...
//                        total = 0;
    ...
    private void Adapter() {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listriwayatstok2,
                new String[]{"namaitem", "qtysebelum", "qty", "qtysekarang", "namauser", "jam", "keterangan"},
                new int[]{R.id.namaitemlistriwayatstok2,R.id.qtysekaranglistriwayatstok2,R.id.qtylistriwayatstok2,R.id.qtysesudahlistriwayatstok2, R.id.namauserlistriwayatstok2, R.id.jamlistriwayatstok2, R.id.keteranganlistriwayatstok2});
