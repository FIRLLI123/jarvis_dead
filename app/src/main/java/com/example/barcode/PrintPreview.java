...
public class PrintPreview extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface{

    EditText idoutletinputperdana1;
    ...
    protected void printDemo() {
        ...
        if (isPrinterReady) {
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(PrintPreview.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
