...
public class ListBayarTempo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_bayar_tempo);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listbayartempo.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listbayartempo,
