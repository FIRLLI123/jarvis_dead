...
public class PrintPreviewEXbyu extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface{
    ...
    Button test, cariid1, foto1, fotobukti1, kevoucher1;;
    int subTotal = 0;
    int total = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.print_preview_exbyu);
...
//                byte[] change1 = new byte[]{27,33, 0};
//                change1[2] = (byte) (0x1 | 0x1); //small
//                mService.write(change1);
                mService.write(PrinterCommands.ESC_ALIGN_LEFT);
                mService.sendMessage(""+Snama, "");

//                byte[] change2 = new byte[]{27,33, 0};
//                change2[2] = (byte) (0x1 | 0x1); //small
//                mService.write(change2);
                mService.write(PrinterCommands.ESC_ALIGN_CENTER);
                mService.sendMessage(""+pr, "");

//                byte[] change = new byte[]{27,33, 0};
//                change[2] = (byte) (0x1 | 0x1); //small
//                mService.write(change);
                mService.write(PrinterCommands.ESC_ALIGN_LEFT);
                mService.sendMessage("("+Sket+")", "");

//                byte[] change3 = new byte[]{27,33, 0};
//                change3[2] = (byte) (0x1 | 0x1); //small
//                mService.write(change3);
//                mService.write(PrinterCommands.ESC_ALIGN_LEFT);
...
//            mService.sendMessage("CASH : "+f, ""); //cash
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(PrintPreviewEXbyu.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
...
**/
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PrintPreviewEXbyu.this);
    ...
    private void transfer() {
        ...
        AndroidNetworking.post(Config.host + "tf.php")
                .addBodyParameter("idoutlet", idoutletinputperdana1.getText().toString())
                .addBodyParameter("namasales", namasalesinputperdana1.getText().toString())
                .addBodyParameter("tanggal", tanggalinputperdana1.getText().toString())
                .setPriority(Priority.MEDIUM)
