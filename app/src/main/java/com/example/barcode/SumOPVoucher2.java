...
public class SumOPVoucher2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_opvoucher2);
...
//        });
        ...
        sumitem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (namaoutletlist1.getText().toString().length() == 0) {                    //1
                    ...
                    String d = tes1.getText().toString();
                    Intent i = new Intent(getApplicationContext(), SumOPVoucherItem.class);
                    //i.putExtra("idoutlet",""+a+"");
    ...
    private void list() {
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post(Config.host + "sumopvoucher2.php")
...
//                        total = 0;
    ...
    private void Adapter() {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listsumopvoucher2,
                new String[]{"idoutlet","namaoutlet", "qty", "item", "via", "total"},
                new int[]{R.id.idoutletlistsum2,R.id.namaoutletlistsum2, R.id.qtylistsum2, R.id.namalistsum2, R.id.vialistsum2, R.id.totallistsum2});
