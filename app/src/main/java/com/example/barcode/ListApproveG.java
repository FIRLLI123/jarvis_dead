...
public class ListApproveG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_approve_g);

        this.mHandler = new Handler();
        m_Runnable.run();


        context = ListApproveG.this;
...
//        });
    ...
    private final Runnable m_Runnable = new Runnable() {
        public void run() {
            ...
            listtangal();
            ListApproveG.this.mHandler.postDelayed(m_Runnable, 10000);
        }
    };
