...
public class Kpi_Ds_Satu extends AppCompatActivity {

    public Spinner bulanspinner;

    ListView listtest1;
    TextView namasales, namabulan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kpi_ds_satu);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Kpi_Ds_Satu.this,android.R.layout.simple_spinner_dropdown_item, item);
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listkpids.php" )
                //.addBodyParameter("satu", namasales.getText().toString())
                .addBodyParameter("dua", bulanspinner.getSelectedItem().toString())
...
**/
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                map.put("tigasembilan",       responses.optString("tigasembilan"));
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listkpisales,
                new String[] {"satu","dua","tigasembilan"},
        ...
        listtest1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(getApplicationContext(), Kpi_DS.class);
