...
public class Group_by_outlet extends AppCompatActivity {

    TextView tes1, tanggal, tanggalsampai;
    ListView listtest1;
    Button refresh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.group_by_outlet);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "group_by_outlet.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listgroup_outlet,
                new String[] {"namaoutlet","qty"},
                new int[] {R.id.namaoutletlist, R.id.qtylist});
