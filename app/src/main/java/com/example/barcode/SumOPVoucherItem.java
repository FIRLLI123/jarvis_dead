...
public class SumOPVoucherItem extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface {
    TextView tanggal1,namasales1,ttl1;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_opvoucher_item);
...
//            mService.sendMessage("Harga Sudah Termasuk PPN 10%", "");
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(SumOPVoucherItem.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumopvoucheritem.php" )
...
//                                item.setJumlah(responses.getString("qty"));
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listsumopitem,
                new String[] {"qty","item","via"},
                new int[] {R.id.qtylistitem, R.id.itemlistitem, R.id.vialistitem});
