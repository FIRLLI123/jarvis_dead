...
public class Performance_V_Transaksi2 extends AppCompatActivity {

    TextView namasales, sum_satu, sum_dua, sum_tiga, sum_empat, sum_lima, sum_enam, sum_tujuh,bulan,idoutlet,pjp_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.performance_v_transaksi2);
        ...
        context = Performance_V_Transaksi2.this;
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Performance_V_Transaksi2.this,android.R.layout.simple_spinner_dropdown_item, item);
    ...
    private final Runnable m_Runnable = new Runnable() {
        public void run() {
            ...
            Performance_V_Transaksi2.this.mHandler.postDelayed(m_Runnable, 2000);
        }
...
**/
    ...
    private void sum_detail() {
        ...
        AndroidNetworking.post(Config.host + "count_detail_voucher.php")
...
//                .addBodyParameter("tanggal", tanggalinputperdana1.getText().toString())
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "list_detail_outlet_nama_v.php" )
