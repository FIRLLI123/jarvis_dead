...
public class SumStokPerdanaLainnya extends AppCompatActivity {
    TextView tes1;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_stok_perdana_lainnya);
...
//        });
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumstok_lainnya.php" )
