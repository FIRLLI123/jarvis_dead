...
public class PrintPreviewEX extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface{
...
//
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(PrintPreviewEX.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
...
//    }
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listinputperdanaEXEX2_ppn.php" )
...
**/
    ...
    private void list_noppn(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listinputperdanaEXEX2_noppn.php" )
                .addBodyParameter("idoutlet", idoutletinputperdana1.getText().toString())
                .addBodyParameter("namasales", namasalesinputperdana1.getText().toString())
                .addBodyParameter("tanggal", tanggalinputperdana1.getText().toString())
                .setPriority(Priority.MEDIUM)
...
//                        jam1.setText((response.optString("jam")));
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PrintPreviewEX.this);
