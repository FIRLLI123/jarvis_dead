...
public class SumLink extends AppCompatActivity {
    TextView tes1;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_link);
...
//                    startActivity(i);
                ...
                if (namasaleslist1.getText().toString().length() == 0) {                    //1
                    ...
                    Intent i = new Intent(getApplicationContext(), SumLink2.class);
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumlink.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listtest,
                new String[] {"namasales","tanggal","qty","namaoutlet","harga"},
