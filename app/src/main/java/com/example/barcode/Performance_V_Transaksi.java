...
public class Performance_V_Transaksi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.performance_v_transaksi);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Performance_V_Transaksi.this,android.R.layout.simple_spinner_dropdown_item, item);
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "list_detail_outlet_v.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.list_detail_outlet_v,
        ...
        listtest1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(getApplicationContext(), Performance_V_Transaksi2.class);
