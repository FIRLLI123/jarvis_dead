...
public class SumBayarTempo2 extends AppCompatActivity {
    TextView tanggal, namasales;
    ListView listtest1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_bayar_tempo2);
    ...
    private void list() {
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post(Config.host + "listbayar2.php")
                .addBodyParameter("tanggalsekarang", tanggal.getText().toString())
...
**/
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                map.put("tanggaltempo",       responses.optString("tanggaltempo"));
                                map.put("tanggalsekarang",       responses.optString("tanggalsekarang"));
...
//                        total = 0;
    ...
    private void Adapter() {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listbayar2,
                new String[]{"idoutlet","namaoutlet", "namaitem", "qty", "tanggaltempo", "tanggalsekarang"},
                new int[]{R.id.idoutletlistbayar2,R.id.namaoutletlistbayar2, R.id.namaitemlistbayar2, R.id.qtylistbayar2, R.id.tanggaltempolistbayar2, R.id.tanggalsekaranglistbayar2});
