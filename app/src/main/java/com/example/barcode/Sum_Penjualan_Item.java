...
public class Sum_Penjualan_Item extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface {

    TextView t_perdana, t_voucher;
    View perdana_v, voucher_v;

    LinearLayout perdana, voucher, punya_perdana, punya_voucher;
    ...
    TextView transferperdana1_voucher;
    TextView cashperdana1_voucher;
    TextView totalperdana1_voucher;

    TextView transferperdana12_voucher;
    TextView cashperdana12_voucher;
    TextView totalperdana12_voucher;


    //-----------------------------
    TextView tanggal1_voucher,namasales1_voucher,ttl1_voucher, ttl21_voucher;
    ListView listtest1_voucher;
    Button carisumitem1_voucher, cetak1_voucher;
    //EditText namasaleslist1;

    private DatePickerDialog datePickerDialog_voucher;
    private SimpleDateFormat dateFormatter_voucher;
    ...
    private List<Data_BayarEX> bayarList_voucher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_penjualan_item);

        punya_perdana = (LinearLayout) findViewById(R.id.punya_perdana);
        punya_voucher = (LinearLayout) findViewById(R.id.punya_voucher);
...
//---------------------
        ...
        transferperdana1_voucher = (TextView) findViewById(R.id.tfperdana_voucher);
        cashperdana1_voucher = (TextView) findViewById(R.id.cashperdana_voucher);
        totalperdana1_voucher = (TextView) findViewById(R.id.totalperdana_voucher);



        transferperdana12_voucher = (TextView) findViewById(R.id.tfperdana12_voucher);
        cashperdana12_voucher = (TextView) findViewById(R.id.cashperdana12_voucher);
        totalperdana12_voucher = (TextView) findViewById(R.id.totalperdana12_voucher);
        ...
        perdana.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                voucher.setBackground(getResources().getDrawable(R.drawable.kotak_transparan_merah));
...
//                listtest2.setVisibility(View.GONE);
                ...
                list();
                transferperdana();
                punya_perdana.setVisibility(View.VISIBLE);
                punya_voucher.setVisibility(View.GONE);
        ...
        voucher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                perdana.setBackground(getResources().getDrawable(R.drawable.kotak_transparan_merah));
...
//                listtest2.setVisibility(View.VISIBLE);
                ...
                aruskas.clear();
                listtest1_voucher.setAdapter(null);
                //listtest1.clear();
                bayarList_voucher.clear();

                list2();
                transferperdana_voucher();
                punya_perdana.setVisibility(View.GONE);
                punya_voucher.setVisibility(View.VISIBLE);
        ...
        bayarList_voucher = new ArrayList<Data_BayarEX>();
        //NumberFormat formatter = new DecimalFormat("#,###,###,###");
        ...
        listtest1_voucher = (ListView) findViewById(R.id.listtest_voucher);
        ...
        ttl1_voucher = (TextView) findViewById(R.id.ttl_voucher);


        ttl21_voucher = (TextView) findViewById(R.id.ttl2_voucher);

        carisumitem1 = (Button) findViewById(R.id.carisumitem);
        cetak1 = (Button) findViewById(R.id.cetak);

        cetak1_voucher = (Button) findViewById(R.id.cetak_voucher);
...
//                    startActivity(i);
        ...
        cetak1_voucher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                int nilai1=Integer.valueOf(ttl21_voucher.getText().toString());
                int nilai2=Integer.valueOf(totalperdana12_voucher.getText().toString());
...
//            mService.sendMessage("Harga Sudah Termasuk PPN 10%", "");
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(Sum_Penjualan_Item.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
    ...
    protected void printDemo_voucher() {
        if (!mService.isAvailable()) {
            Log.i(TAG, "printText: perangkat tidak support bluetooth");
            return;
        }
        if (isPrinterReady) {
            ...
            String c = transferperdana1_voucher.getText().toString();
            String d = cashperdana1_voucher.getText().toString();
            //String c = idoutletinputperdana1.getText().toString();
            // TOTAL LINE 32
            ...
            mService.write(PrinterCommands.biasa);
            //mService.sendMessage("Wisma Barcode Jakarta Barat", "");
            mService.sendMessage("RINCIAN SETORAN VOUCHER", "");
            //mService.sendMessage("WISMA BARCODE JAKARTA BARAT", "");
            mService.write(PrinterCommands.FEED_PAPER_AND_CUT);
            mService.write(PrinterCommands.small);
...
//            mService.sendMessage("Fax. (62-21)7902523", "");
            ...
            mService.sendMessage(""+ans, "");
            mService.sendMessage("................................", "");
            for(int i=0; i<bayarList_voucher.size(); i++) {

                Data_BayarEX data = bayarList_voucher.get(i);
                int quantity = Integer.parseInt(bayarList_voucher.get(i).getJumlah());
                //int ket = Integer.parseInt(bayarList.get(i).getKeterangan());
                int sub = quantity * Integer.parseInt(bayarList_voucher.get(i).getHarga());
                String Ssub = ""+formatter.format(sub);
                String Snama = ""+bayarList_voucher.get(i).getNama();
                //String Sket = ""+bayarList.get(i).getKeterangan();
                //Double ket = Double.parseDouble(bayarList.get(i).getKeterangan());

                int Shh = Integer.parseInt(bayarList_voucher.get(i).getHarga());
                String Sjml = ""+quantity+" x @"+formatter.format(Shh);
...
**/
    ...
    private void list2(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumitemvoucherex.php" )
                .addBodyParameter("tanggal", tanggal1.getText().toString())
                .addBodyParameter("namasales", namasales1.getText().toString())
                .setPriority(Priority.MEDIUM)
                .build()
...
**/
                        ...
                        ttl1_voucher.setText("Rp "+formatter.format(total));
                        String hasil3 = String.valueOf(totalstring);
                        ttl21_voucher.setText(hasil3);
                        total = 0;
                    }
                    @Override
                    public void onError(ANError error) {
    ...
    private void Adapter2(){
        ...
        listtest1_voucher.setAdapter(simpleAdapter);

        listtest1_voucher.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //tanggal        = ((TextView) view.findViewById(R.id.tanggal)).getText().toString();
                //ListMenu();
...
//                        jam1.setText((response.optString("jam")));
    ...
    private void transferperdana_voucher() {
        ...
        AndroidNetworking.post(Config.host + "tfvoucherbayar.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        transferperdana12_voucher.setText((response.optString("transfer")));
                        transferperdana1_voucher.setText(
                                rupiahFormat.format(response.optDouble("transfer")));


                        cashperdana12_voucher.setText((response.optString("cash")));
                        cashperdana1_voucher.setText(
                                rupiahFormat.format(response.optDouble("cash")));

                        totalperdana12_voucher.setText((response.optString("total")));
                        totalperdana1_voucher.setText(
                                rupiahFormat.format(response.optDouble("total")));

//                        tanggal1.setText((response.optString("tanggal")));
//                        jam1.setText((response.optString("jam")));

                        if ( transferperdana12_voucher.getText().toString().equals("null")){
                            transferperdana12_voucher.setText("0");
                            cashperdana12_voucher.setText("0");
                        }else{
