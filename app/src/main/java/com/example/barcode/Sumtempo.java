...
public class Sumtempo extends AppCompatActivity {
    ListView listtest1;
    TextView namasales;

    public static String LINK, namasaleslist, pembayaran, totallist, hargalistperdana, totallistperdana;
    ArrayList<HashMap<String, String>> aruskas = new ArrayList<HashMap<String, String>>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sumtempo);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "listtempo.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listtempo,
                new String[] {"namasales"},
                new int[] {R.id.namasaleslisttempo});
        ...
        listtest1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                namasaleslist    = ((TextView) view.findViewById(R.id.namasaleslisttempo)).getText().toString();
                ...
                Intent i = new Intent(getApplicationContext(), SumTempo2.class);
