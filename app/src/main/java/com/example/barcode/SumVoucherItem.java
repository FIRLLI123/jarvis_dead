...
public class SumVoucherItem extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface {
    ...
    private static final String TAG = SumVoucherItem.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_voucher_item);
...
//            mService.sendMessage("Harga Sudah Termasuk PPN 10%", "");
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(SumVoucherItem.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
