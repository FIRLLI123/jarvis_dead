...
public class Rank_sales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rank_sales);
...
//        day = c.get(Calendar.DATE);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumex_rank.php" )
...
//        });
    ...
    private void list2(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumvoucherex_rank.php" )
                .addBodyParameter("tanggal", tes1.getText().toString())
                .addBodyParameter("tanggalsampai", tanggalsampai.getText().toString())
                .setPriority(Priority.MEDIUM)
                .build()
