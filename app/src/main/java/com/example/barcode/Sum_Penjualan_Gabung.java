...
public class Sum_Penjualan_Gabung extends AppCompatActivity {
    TextView tes1, tanggalsampai,detaildata, t_perdana, t_voucher,detaildata_voucher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sum_penjualan_gabung);
...
//                    startActivity(i);
        ...
        Intent i = getIntent();
        String kiriman = i.getStringExtra("posisi");
        posisi.setText(kiriman);
...
//                        total = 0;
    ...
    private void list2(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "sumvoucherex_update.php" )
                .addBodyParameter("tanggal", tes1.getText().toString())
                .addBodyParameter("tanggalsampai", tanggalsampai.getText().toString())
                .addBodyParameter("posisi", bo.getText().toString())
