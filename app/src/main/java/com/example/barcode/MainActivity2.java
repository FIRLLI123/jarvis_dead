...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener {
    // View Object
    private Button btnkeLogin, btndatastudio, newoutlet1, telegram1, sum2, km2, cari1;
    ...
    TextView validasipass1,sls1, namasalesforward;
...
//                    startActivity(i);
        ...
        newoutlet2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String a = namasalesforward.getText().toString();
