...
public class Item_Voucher_pilihan extends AppCompatActivity {
    ...
    LinearLayout perdana, voucher, caridatabarang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_voucher_pilihan);
...
//                namaoutletlist1.setText(namaoutletlist);
    ...
    private void list2() {
        ...
        //Log.d("link", LINK );
        //AndroidNetworking.post(Config.host + "sumstok2_v2.php")
        AndroidNetworking.post(Config.host + "pilihan_stok_voucher.php")
                //.addBodyParameter("tanggal", tes1.getText().toString())
