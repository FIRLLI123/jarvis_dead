...
import com.example.barcode.Data.Data_Bayarlink;
...
public class PrintPreviewLink extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, BluetoothHandler.HandlerInterface{
    ...
    private List<Data_Bayarlink> bayarList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_print_preview_link);
    ...
    protected void printDemo() {
        ...
        if (isPrinterReady) {
            ...
            for(int i=0; i<bayarList.size(); i++) {
                ...
                //Data_Bayarlink data = bayarList.get(i);
...
//            mService.write(PrinterCommands.ESC_ALIGN_LEFT);
//            mService.sendMessage("Biaya Admin", "");
            //mService.write(PrinterCommands.ESC_ALIGN_RIGHT);
            //mService.sendMessage("1000", "");
            ...
            if (mService.isBTopen())
                startActivityForResult(new Intent(PrintPreviewLink.this, DeviceActivity.class), RC_CONNECT_DEVICE);
            else
                requestBluetooth();
        }
...
**/
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                Data_Bayarlink item = new Data_Bayarlink();
                                ...
                                total += Integer.parseInt(responses.getString("harga"));
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listinputlinkprint,
                new String[] {"item", "harga"},
                new int[] {R.id.namalink, R.id.nominallink});
