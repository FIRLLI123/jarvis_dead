...
public class DataOutlet_Performance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_outlet_performance);
...
//                resultIntent.putExtra("namaoutlet",""+a+"");
//                resultIntent.putExtra("idoutlet",""+b+"");
