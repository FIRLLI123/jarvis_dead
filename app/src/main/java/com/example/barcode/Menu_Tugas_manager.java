...
public class Menu_Tugas_manager extends AppCompatActivity {
    ...
    public static String LINK,idoutletlist, namasaleslist;
    ArrayList<HashMap<String, String>> aruskas = new ArrayList<HashMap<String, String>>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.menu_tugas_manager);
    ...
    private void list(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "data_sales.php" )
...
//                        total = 0;
    ...
    private void Adapter(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.listnamasales,
                new String[] {"namasales"},
                new int[] {R.id.namasaleslist});
        ...
        listdataoutlet1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                namasaleslist  = ((TextView) view.findViewById(R.id.namasaleslist)).getText().toString();
                ...
                String c = namasales.getText().toString();
